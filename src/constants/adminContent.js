...
const defaultAdminContent = {
  ...
  music: {
    header: {
      eyebrow: "Panel privado",
      title: "Escaleta musical",
      text: "Organiza momentos, canciones y bloques de vuestra boda.",
    },
    list: {
      eyebrow: "Planificación sonora",
      title: "Momentos de la boda",
      songsCount: (count) => `${count} canciones`,
    },
    actions: {
    ...
    forms: {
      momentTitle: "Momento musical",
      songTitle: "Canción",
      blockTitle: "Bloque musical",
      momentName: "Nombre del momento",
      description: "Descripción",
      name: "Nombre",
      performer: "Nombre / intérprete",
      songTitleLabel: "Título",
      notes: "Notas",
      style: "Estilo de música",
      duration: "Duración (H:mm)",
    },
  },
  guests: {
    tabs: [

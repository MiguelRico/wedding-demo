...
const defaultAdminContent = {
  ...
  exports: {
    ...
    providers: {
      ...
      text: "Genera un PDF agrupado por proveedor con sus servicios, importes y estado de los pagos.",
    ...
    seating: {
      ...
      text: "Genera un plano visual con mesas, asientos, invitados asignados y sus datos principales.",
      action: "Descargar PDF",
    ...
    workbook: {
      ...
      text: "Exporta los datos actuales del evento: confirmaciones, invitados, mesas, proveedores, avisos y tareas.",
    ...
    confirmationsPdf: {
      ...
      text: "Prepara un PDF por confirmación con invitados, menús, alergias, transporte y asignación de mesa.",
      action: "Descargar PDF",

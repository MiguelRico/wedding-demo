...
export const MusicMoment = {
  create(input = {}) { const value = text(input.id || input.momentId) || id(); return { id: value, momentId: value, label: text(input.label), description: text(input.description), icon: text(input.icon) || "Music" }; },
